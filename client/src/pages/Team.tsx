  ...
  return (
    <div className="bg-surface-container-low p-8 rounded-3xl min-h-[400px] flex items-center justify-center border border-outline-variant/10">
      <div className="text-center">
        <span className="material-symbols-outlined text-6xl text-indigo-200 mb-4">group</span>
        <h1 className="text-2xl font-bold text-indigo-900 font-headline">Команда</h1>
